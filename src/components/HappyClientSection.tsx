            ...
            <div className="container mx-auto grid md:grid-cols-2 xl:grid-cols-3 gap-4 md:gap-6 xl:gap-8">
                <aside data-aos-duration="1000" data-aos="fade-up-right" className="flex flex-col gap-4 relative">
                    <div className="flex items-center gap-2">
                        <div className="relative bg-secondary h-10 w-10 md:h-12 md:w-12 rounded-full overflow-hidden flex-shrink-0">
                        ...
                        <div data-aos-duration="1000" data-aos-delay="1000" data-aos="zoom-in-left" className="flex-1 flex flex-col justify-center gap-1 pt-2">
                            <Para1 className='-my-2 text-primary font-eugusto'>Bright Medugu</Para1>
                            <Para3 variant='secondary' className='opacity-70'>September, {new Date().getFullYear()}</Para3>
                        </div>
                    </div>
                    <Para3 className='text-text text-justify'>Everything was great. Evelyn was very kind and responsive. She always answered us very quick. Check in was very smooth as well. the building itself was literally amazing and we basically enjoyed every moment in there.</Para3>
                </aside>
                <aside data-aos-duration="1000" data-aos="fade-up-right" className="flex flex-col gap-4 relative">
                    <div className="flex items-center gap-2">
                        <div className="relative bg-secondary h-10 w-10 md:h-12 md:w-12 rounded-full overflow-hidden flex-shrink-0">
                        ...
                        <div data-aos-duration="1000" data-aos-delay="1000" data-aos="zoom-in-left" className="flex-1 flex flex-col justify-center gap-1 pt-2">
                            <Para1 className='-my-2 text-primary font-eugusto'>Monday Daniel</Para1>
                ...
                <aside data-aos-duration="1000" data-aos="fade-up-right" className="flex flex-col gap-4 relative">
                    <div className="flex items-center gap-2">
                        ...
                        <div data-aos-duration="1000" data-aos-delay="1000" data-aos="zoom-in-left" className="flex-1 flex flex-col justify-center gap-1 pt-2">
                            <Para1 className='-my-2 text-primary font-eugusto'>Mahmoud Sani</Para1>
