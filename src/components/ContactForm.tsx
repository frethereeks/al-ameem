...
export default function ContactForm() {
  return (
      <section className='bg-primary py-10 lg:py-20 px-4'>
          <div className="container mx-auto px-4 md:px-8 lg:px-10 rounded-xl grid lg:grid-cols-2 gap-4 lg:gap-8 justify-center">
              ...
              <aside className="relative flex flex-col py-5">
                  ...
                  <Header1 className='text-white font-medium font-eugusto max-w-sm'>Reaching out in minutes</Header1>
