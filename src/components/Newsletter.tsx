...
export default function Newsletter() {
    return (
        <section className='relative bg-background py-10 lg:py-20 md:px-4'>
            <div className="container mx-auto bg-primary py-10 lg:py-20 px-4 lg:px-10 rounded-[2%] sm:rounded-xl grid lg:grid-cols-2 md:justify-center">
